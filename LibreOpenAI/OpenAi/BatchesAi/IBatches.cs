...
namespace LibreOpenAI.OpenAi.BatchesAi
{
    public interface IBatches : ICreationBase
    {
        ...
        /// Retrieves a batch.
        /// </summary>
        /// <param name="batch_id">The ID of the batch to retrieve. It's a string - Required path parameter</param>
        ...
        /// </summary>
        /// <param name="batch_id">The ID of the batch to cancel. It's a string - Required path parameter</param>
        /// <returns>The Batch object matching the specified ID.</returns>
        ...
        /// </summary>
        /// <param name="limit">A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. It's an integer - Optional query parameter - Defaults to 20</param>
